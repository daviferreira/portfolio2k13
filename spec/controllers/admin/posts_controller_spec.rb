    ...
    describe "create post" do
      ...
      describe "with invalid post data" do
        it "should render new post template" do
          ...
          response.should render_template("admin/posts/new")
        end
      end
      ...
      describe "PUT 'update'" do
        ...
        describe "with invalid post data" do
          ...
          it "should render edit post template" do
            ...
            response.should render_template("admin/posts/edit")
          end
        end
        ...
        describe "with valid post data" do
          it "redirects to post path" do
            ...
            blog_post.reload
            response.should redirect_to edit_admin_post_path(blog_post)
          end
